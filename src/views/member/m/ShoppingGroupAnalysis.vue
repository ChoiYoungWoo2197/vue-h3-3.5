    ...
    <div class="m m-wrap">
      ...
      <section>
        <article class="dashboard-card">
          <div class="title"><h3>상품 정보</h3></div>
        ...
        <article class="statistics-report">
          ...
          <div
            ...
            :key="data.skeyword + '-' + getUuidv4()"
          >
            <ul>
              <div class="m-table-title">
                <div class="w-100">
                  <li class="font-weight-bold">{{ data.skeyword }}</li>
                </div>
              </div>
...
export default {
  data() {
    return {
      ...
      uniqueId: null,
      product: { isAdPid: null, adPid: null, adId: null, name: null, type: null },
      media: "N",
      main: {
        field: "",
        query: null,
  ...
  mounted() {
    ...
    this.product.isAdPid = this.$route.query.isadpid;
    this.product.isAdPid === "1"
      ? (this.product.adPid = this.$route.query.id)
      : (this.product.adId = this.$route.query.id);
    this.product.name = this.$route.query.name;
  ...
  methods: {
    ...
    getReport() {
      ...
      $.ajax({
        ...
        data: {
          ...
          kpi: "",
          adpid: vm.product.isAdPid === "1" ? vm.product.adPid : "",
          adid: vm.product.isAdPid === "0" ? vm.product.adId : "",
    ...
    exportExcel(data, options) {
      ...
      a.href = url;
      a.download = moment().format("LLLL") + "-" + "쇼핑검색광고키워드" + ".xlsx";
