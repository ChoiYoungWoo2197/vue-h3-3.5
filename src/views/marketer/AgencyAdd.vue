    ...
    <div class="full-wrap d-flex flex-column">
      <article class="newad agencyAdd">
        ...
        >
          ...
          <button type="submit" class="btn shadow-none">에이전트 등록</button>
        </form>
      </article>
    </div>
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (this.ajax) {
        $.ajax({
          type: "POST", //요청 메소드 방식
          url: API_URL + "/admin/agentregister",
