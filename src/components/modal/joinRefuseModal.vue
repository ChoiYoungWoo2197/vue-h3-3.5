<template>
    <div class="modal fade joinRefuse" :id="getUniqueId" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="joinRefuse" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<p class="modal-mail">확인을 누르면 가입거절 메일이 발송됩니다.</p>
