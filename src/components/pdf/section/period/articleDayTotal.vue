<template>
  <div :class="getUniqueId">
    <template v-for="(index, i) in main.periodAnalysis.total[3].day.total.pdf.end" :key="index + i + '-' + getUuidv4()">
      <div  class="pdf-a4-l periodAnalysis">
        ...
        <section class="d-flex pdf-card pdf-card-2 naver">
          <div v-show="index === 1" class="row justify-content-between">
            <div class="col crossGraphPeriodTotalOneday d-flex justify-content-center">
              <div id="crossGraphPeriodTotalOneday" class="crossGraphPeriodTotalOneday" ></div>
            </div>
            <div class="col crossGraphPeriodTotalTwoday d-flex justify-content-center">
              <div id="crossGraphPeriodTotalTwoday" class="crossGraphPeriodTotalTwoday" ></div>
            </div>
          </div>
          <div class="report">
            <table class="report">
              ...
              <tbody v-if="main.periodAnalysis.responseData !== null">
                <tr v-for="(data, index2) in getDatasForPeriodTotal(3, 'day', index)" :key="index2 + '-' + getUuidv4()" >
