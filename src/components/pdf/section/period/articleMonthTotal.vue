<template>
  <div :class="getUniqueId">
    <template v-for="(index, i) in main.periodAnalysis.total[2].month.total.pdf.end" :key="index + i + '-' + getUuidv4()">
      <div  class="pdf-a4-l periodAnalysis">
        ...
        <section class="d-flex pdf-card pdf-card-2 naver">
          <div v-show="index === 1" class="row justify-content-between">
            <div class="col crossGraphPeriodTotalOnemonth d-flex justify-content-center">
              <div id="crossGraphPeriodTotalOnemonth" class="crossGraphPeriodTotalOnemonth" ></div>
            </div>
            <div class="col crossGraphPeriodTotalTwomonth d-flex justify-content-center">
              <div id="crossGraphPeriodTotalTwomonth" class="crossGraphPeriodTotalTwomonth" ></div>
            </div>
          </div>
          <div class="report">
            <table class="report">
              ...
              <tbody v-if="main.periodAnalysis.responseData !== null">
                <tr v-for="(data, index2) in getDatasForPeriodTotal(2, 'month', index)" :key="index2 + '-' + getUuidv4()" >
