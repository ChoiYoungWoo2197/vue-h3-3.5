<template>
  <div :class="getUniqueId">
    <template v-for="(index, i) in main.keywordAnalysis.pages[2].google.pdf.end" :key="index + i + getUuidv4()">
      <div  class="pdf-a4-l keywordAnalysis">
        ...
        <section class="d-flex pdf-card pdf-card-2 google">
          <div class="report keyword10-container" v-if="main.keywordAnalysis.pages[2].google.responseData !== null">
            <template v-for="(k, i) in Object.keys(sortDraggable())" :key="k + i + getUuidv4()">
              <div  class="keyword10-container-item">
                <table>
                  ...
                  <tbody>
                    <template v-for="(d, i) in main.keywordAnalysis.pages[2].google.responseData.data.kpis[k]" :key="d+i+getUuidv4">
                      <tr >
      ...
      $.ajax({
        ...
        success: function (data) {
          if(data.result === "success") {
            ["naver", "kakaosa", "google"].forEach(function (media, index) {
