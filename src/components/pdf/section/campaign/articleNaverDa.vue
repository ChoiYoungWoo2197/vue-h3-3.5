<template>
  <div :class="getUniqueId">
    <template v-for="(index, i) in main.campaignAnalysis.pages[3].naverda.pdf.end" :key="index + i + '-' + getUuidv4()">
          ...
          <div class="report">
            <table class="report">
              ...
              <tbody v-if="main.campaignAnalysis.responseData !== null">
                <tr
                  v-for="(data, index2) in getDatasForCampaign('naverda', 3, index)"
                  :key="data.cst + '-' + index2"
                  :class="
                ...
                <template v-if="index === main.campaignAnalysis.pages[3]['naverda'].pdf.end">
                  <tr
                    v-for="data in main.campaignAnalysis.pages[3].naverda.total"
                    :key="data.cst + 'L'"
