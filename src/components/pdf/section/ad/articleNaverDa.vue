<template>
  <div :class="getUniqueId" class="pdf-a4-l adAnalysis" >
    <template v-for="(index, i) in main.adAnalysis.pages[3].naverda.pdf.end" :key="index + i + getUuidv4()">
      <div  class="pdf-a4-l adAnalysis">
        ...
        <section class="d-flex pdf-card pdf-card-2 naverda">
            <div class="report banner">
              <table class="report banner"  v-if="main.adAnalysis.pages[3].responseData !== null">
                <thead>
                  <tr>
                ...
                <tbody>
                  <template v-for="(d, i) in getDatasForAd('naverda', 3, index)" :key="i + getUuidv4()">
                    <tr >
...
import { clearBody, addClassDashboard, priceToString, getMedia, getApp, uuidv4, sortWeekDay, isEmptyObject, getDateStr2, downloadImage, toDataURL, sortDraggable, getKpiName } from "../../../../assets/js/common.js";
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if (data.result === "success") {
            ["naver", "kakaosa", "kakaomo", "naverda"].forEach(function (media, index) {
              if (media === "naver" || media === "kakaosa" || media === "kakaomo") return;
              if (vm.report.activePage.adAnalysis && vm.report.activeMedia[media]) {
                ...
                vm.$emit("finished", {graph: "adreportnaverdaForAdToBanner", status: true});
              }
            });
          } else {
          }
